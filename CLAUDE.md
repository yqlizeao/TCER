...
| `metrics.py` | 全部公式：TCER/CHR/CPE/CAF/TTAF/TA-TCER/PSAC/NCPI/churn/CTEI + 评级 + 逐模型成本 + compute/save_baselines |
...
| `export.py` | JSON/CSV/Markdown 序列化 + CTEI 排名数据（`ctei_ranking`）+ 文本条形图 |
