...
GROUPS: list[Group] = [
    ...
    Group("G3", "缓存效率", [
        Metric("chr", "缓存命中率", "",
               ...
               "缓存效率取决于提示词稳定性——重复使用相似上下文时缓存更有效。", "basic"),
    ...
    Group("G4", "代码产出与质量", [
        ...
        Metric("search_edit_ratio", "搜索后编辑比", "",
               ...
               "搜索本身没有 file_path 的纯探索不计入。", "basic"),
        Metric("read_before_write", "先读后写率", "",
               "被写入/编辑的文件中，在之前回合被 Read 过的比例。越高越好——"
               "100% 说明每次修改前都充分阅读了代码；低值说明 AI 在「盲写」没读过的文件。", "basic"),
    ]),
    Group("G5", "成本分析", [
        Metric("cost", "总成本", "美元",
    ...
    Group("G6", "综合评分", [
        ...
        Metric("ncpi", "净产出指数", "",
               ...
               "项目越大，每次改动占比越低——这是自然趋势，不是低效。", "basic"),
        Metric("psac", "阶段调整系数", "",
