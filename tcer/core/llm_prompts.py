...
_DYNAMICS_SYSTEM = (
    ...
    "  \"trajectory\": [\n"
    "    {\"turn\": 1, \"semantic_distance\": 0.85, \"vector\": \"positive\", \"event\": \"normal\", \"note\": \"首次按需求生成骨架\"}\n"
    "  ],\n"
    "  \"capabilities\": {\n"
    ...
    "- trajectory 需提取会话中 4~12 个关键转折回合（覆盖首回合、关键偏离回合、重大纠错回合、末回合），turn 为真实回合序号（1-indexed 数字）；\n"
