...
ALLOWED_RESIDUAL_HEX = "#000000", "#0070dd", "#007acc", "#14202e", "#142814", "#1a3a5a", "#2a2a2a", "#2e1414", "#2e1e14", "#2e2a14", "#2fc4c4", "#3a3a3a", "#42a5f5", "#444444", "#4aa8ec", "#4cc96a", "#4ec9b0", "#555555", "#569cd6", "#6B7077", "#6a6a6a", "#888888", "#9cdcfe", "#9d9da5", "#a335ee", "#b65bd6", "#c586c0", "#c62828", "#ce9178", "#dcdcaa", "#e2a23c", "#e53935", "#ef6c00", "#f9a825", "#ffd700"
