...
def test_analyze_claude_folds_subagent_and_aggregate_score_valid(tmp_path, monkeypatch):
    ...
    # 综合效率分聚合有效（三正交轴，不再抑制）。
    assert result.aggregate.score is not None
    assert result.aggregate.tier is not None
